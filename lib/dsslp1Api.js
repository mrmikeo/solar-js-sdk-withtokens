/*
 * A Promised NodeJS Module for connecting with the Solar SSLP1 API
 */
...
var solarSlp1 = /** @class */ (function() {

    function solarSlp1(solarApi, apiURL) {
        if (apiURL === void 0)
            this.apiURL = 'https://slp.testnet.sh/api';
        else
            this.apiURL = apiURL;
    ...
    solarSlp1.prototype.getApiUrl = function() {
    ...
    solarSlp1.prototype.getStatus = function() {
    ...
    solarSlp1.prototype.getPeerInfo = function() {
    ...
    solarSlp1.prototype.listTokens = function(limit = 100, page = 1) {
    ...
    solarSlp1.prototype.getToken = function(tokenid) {
    ...
    solarSlp1.prototype.getTokenWithMeta = function(tokenid) {
    ...
    solarSlp1.prototype.getTokenIdByTxid = function(transactionid) {
    ...
    solarSlp1.prototype.getTokensByOwner = function(address = '', limit = 100, page = 1) {
    ...
    solarSlp1.prototype.listAddresses = function(limit = 100, page = 1) {
    ...
    solarSlp1.prototype.getAddress = function(address) {
    ...
    solarSlp1.prototype.getAddressesByTokenId = function(tokenid = '', limit = 100, page = 1) {
    ...
    solarSlp1.prototype.getBalance = function(tokenid = '', address = '') {
    ...
    solarSlp1.prototype.listTransactions = function(limit = 100, page = 1) {
    ...
    solarSlp1.prototype.getTransaction = function(transactionid = '') {
    ...
    solarSlp1.prototype.listTokenTransactions = function(tokenid = '', limit = 100, page = 1) {
    ...
    solarSlp1.prototype.listTokenAddressTransactions = function(tokenid = '', address = '', limit = 100, page = 1) {
    ...
    solarSlp1.prototype.generateToken = function(passPhrase = '', secondPassphrase = null, tokenName = '', tokenTicker = '', tokenQuantity = 0, tokenDecimals = 8, tokenUri = '', tokenNote = '', tokenPausable = false, tokenMintable = false) {
            ...
            (async() => {
                ...
                try {
                    ...
                    if (error == false) {
						...
						var transaction = this.sapi.buildTransaction(toAddress, solarAmount, vendorField, passPhrase, secondPassphrase, feeOverride);

                        var transactionId = transaction.id;

                        var sendResult = await this.sapi.createTransaction([transaction]);
    ...
    solarSlp1.prototype.mintToken = function(passPhrase = '', secondPassphrase = null, tokenId = '', mintQuantity = 0, transactionNote = '') {
    ...
    solarSlp1.prototype.burnToken = function(passPhrase = '', secondPassphrase = null, tokenId = '', burnQuantity = 0, transactionNote = '') {
    ...
    solarSlp1.prototype.sendToken = function(passPhrase = '', secondPassphrase = null, tokenId = '', toAddress = '', sendQuantity = 0, transactionNote = '') {
            ...
            (async() => {
                ...
                try {
                    ...
                    if (tokeninfo[0] && tokeninfo[0].tokenDetails) {
                        ...
                        var senderaddress = SolarIdentities.Address.fromPassphrase(passPhrase);
    ...
    solarSlp1.prototype.pauseToken = function(passPhrase = '', secondPassphrase = null, tokenId = '', transactionNote = '') {
    ...
    solarSlp1.prototype.resumeToken = function(passPhrase = '', secondPassphrase = null, tokenId = '', transactionNote = '') {
    ...
    solarSlp1.prototype.newTokenOwner = function(passPhrase = '', secondPassphrase = null, tokenId = '', newOwnerAddress = '', transactionNote = '') {
