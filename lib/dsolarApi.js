...
const { Transactions: SolarTransactions, Managers: SolarManagers, Utils: SolarUtils, Identities: SolarIdentities } = require("@solar-network/crypto"); //https://github.com/Solar-network/crypto
...
var solarApi = /** @class */ (function() {
	...
	solarApi.prototype.getNewAddress = function() {
	...
	solarApi.prototype.validateAddress = function(address) {
		return new Promise((resolve, reject) => {
			(async () => {
	...
	solarApi.prototype.buildTransaction = function(receiverAddress, amount, memo, passPhrase, secondPassphrase = null, feeOverride = null) {
		return new Promise((resolve, reject) => {
			(async () => {

				try {

					var senderId = SolarIdentities.Address.fromPassphrase(passPhrase);

					request.get(this.apiURL + '/wallets/' + senderId, { json: true }, function(error, response, body) {
						...
						var walletbalance = body.data.balance;

						if (Big(amount).gt(walletbalance))
						{
							reject('Sender has Insufficient Funds!');
						}
						
						var validaddress = SolarIdentities.Address.validate(receiverAddress);
						...
						var currentnonce = body.data.nonce;
						...
						var feeStats = await this.getNodeFeeStats();
						var averageFee = feeStats.data[1]['transfer']['avg'];

						if (feeOverride != null)
						{
							averageFee = feeOverride;
						}
						...
						var signedTransaction = itransaction.build().toJson();
    ...
    solarApi.prototype.getBlockChain = function() {
    ...
    solarApi.prototype.getBlockHeight = function() {
    ...
    solarApi.prototype.listBlocks = function(page, limit, id, height, orderBy) {
    ...
    solarApi.prototype.getBlockByHeight = function(height) {
    ...
    solarApi.prototype.getBlockByID = function(id) {
    ...
    solarApi.prototype.getLastBlock = function() {
    ...
    solarApi.prototype.getTransactionsByBlockID = function(id) {
    ...
    solarApi.prototype.searchBlocks = function(page, limit, body) {
    ...
    solarApi.prototype.listDelegates = function(page, limit, orderBy) {
    ...
    solarApi.prototype.getDelegate = function(identifier) {
    ...
    solarApi.prototype.getDelegateBlocks = function(identifier, page, limit) {
    ...
    solarApi.prototype.getDelegateVoters = function(identifier, page, limit) {
    ...
    solarApi.prototype.searchDelegates = function(page, limit, body) {
    ...
    solarApi.prototype.getNodeConfig = function() {
    ...
    solarApi.prototype.getNodeCryptoConfig = function() {

        /*
        
            Used to access a Node's configuration for the @solar/crypto package that handles all cryptography operations.
    ...
    solarApi.prototype.getNodeFeeStats = function() {
    ...
    solarApi.prototype.getNodeStatus = function() {
    ...
    solarApi.prototype.getNodeSyncStatus = function() {
    ...
    solarApi.prototype.getPeers = function(page, limit, port, status, os, version, orderBy) {
    ...
    solarApi.prototype.getPeerByIP = function(ip) {
    ...
    solarApi.prototype.createTransaction = function(transactions) {

        /*
        
            Creating the correct payload for a transaction is non-trivial, as it requires cryptographic functions and a specific serialization protocol. Our crypto SDKs provide the functionality needed in most major programming languages. https://www.github.com/solar-network/
    ...
    solarApi.prototype.getTransactionByID = function(id) {
    ...
    solarApi.prototype.listTransactions = function(page, limit, type, blockId, id, orderBy) {
    ...
    solarApi.prototype.listUnconfirmedTransactions = function(page, limit) {
    ...
    solarApi.prototype.getUnconfirmedTransactionByID = function(id) {
    ...
    solarApi.prototype.searchTransactions = function(page, limit, body) {
    ...
    solarApi.prototype.getTransactionTypes = function() {

        /*
        
            The transaction types are network specific. Solar currently supports eight different types, but BridgeChains may define more or less if needed for their business purpose.
    ...
    solarApi.prototype.getTransactionFees = function() {
    ...
    solarApi.prototype.listVotes = function(page, limit, orderBy) {
    ...
    solarApi.prototype.getVoteByID = function(id) {
    ...
    solarApi.prototype.listWallets = function(page, limit, orderBy) {
    ...
    solarApi.prototype.getWalletByID = function(id) {
    ...
    solarApi.prototype.getWalletBalance = function(id) {
    ...
    solarApi.prototype.getWalletTransactions = function(id, page, limit) {
    ...
    solarApi.prototype.getWalletReceivedTransactions = function(id, page, limit) {
    ...
    solarApi.prototype.getWalletSentTransactions = function(id, page, limit) {
    ...
    solarApi.prototype.getWalletVotes = function(id, page, limit) {
    ...
    solarApi.prototype.getTopWallets = function(page, limit) {
    ...
    solarApi.prototype.searchWallets = function(page, limit, body) {
